        ...
        @if(Auth::user()->role == 'Admin')
            ...
            <div class="card text-white bg-[#0006] w-96 shadow-sm">
                <figure class="h-[240px]">
                    <img class="object-cover" src="{{ asset('images/usuarios.jpg') }}" />
                </figure>
                <div class="card-body">
                    <h2 class="card-title">
            ...
            <div class="card text-white bg-[#0006] w-96 shadow-sm">
                <figure class="h-[240px]">
                    <img class="object-cover" src="{{ asset('images/mascota.jpg') }}" />
                </figure>
                <div class="card-body">
                    <h2 class="card-title">
                        <svg xmlns="http://www.w3.org/2000/svg" class="size-10" fill="currentColor" viewBox="0 0 256 256">
            ...
            <div class="card text-white bg-[#0006] w-96 shadow-sm">
                <figure class="h-[240px]">
                    <img class="object-cover" src="{{ asset('images/adopcion.webp') }}" />
                </figure>
                <div class="card-body">
                    <h2 class="card-title">
                        <svg xmlns="http://www.w3.org/2000/svg" class="size-10" fill="currentColor" viewBox="0 0 256 256">
            ...
            <div class="card text-white bg-[#0006] w-96 shadow-sm">
                ...
                <div class="card-body">
                    <h2 class="card-title">
                        ...
                        My Adoptions <span
                            class="badge badge-dark">{{ App\Models\Adoption::where('user_id', Auth::user()->id)->count() }}</span>
                    </h2>
